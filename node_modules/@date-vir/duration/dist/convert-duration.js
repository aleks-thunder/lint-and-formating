...
import { flattenUnitsSmallestToLargest, } from './duration-selection.js';
...
units, rawOptions = {}) {
    const finalDuration = {};
    const options = {
        decimalCount: rawOptions.decimalCount == undefined
            ? undefined
    ...
    selectedUnits.forEach((durationUnit, index) => {
        ...
        if (durationUnit === DurationUnit.Milliseconds) {
            ...
            const absoluteRoundedUnitQuantity = isLastUnit
                ...
                : Math.floor(options.decimalCount == undefined
                    ? absoluteQuantity
