 ...
 * ```
 */
export declare function defineTypedEvent<const EventType extends string, const SuperClass extends typeof Event = typeof Event>(type: EventType, SuperClass?: SuperClass): (new (eventInitDict?: EventInit) => InstanceType<SuperClass> & TypedEvent<EventType>) & Overwrite<SuperClass, Pick<TypedEvent<EventType>, "type">>;
