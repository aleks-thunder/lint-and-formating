...
export class GenericListenTarget {
     ...
     */
    listen(eventClass, listenerCallback, options = {}) {
        const genericCallback = listenerCallback;
     ...
     */
    removeListener(eventClass, listenerCallback) {
        const genericCallback = listenerCallback;
    ...
    getOrCreateInnerMap(eventClass) {
